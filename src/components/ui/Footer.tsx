    ...
    <footer className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm font-kabel text-muted-foreground">Design System</div>
              </div>
            </div>
            
            <p className="text-sm text-muted-foreground font-kabel leading-relaxed mb-6">
              Creating beautiful, accessible, and performant digital experiences with modern web technologies and thoughtful design.
            </p>
          ...
          {/* Navigation Sections */}
          {showNavigation && navigationSections.map((section, index) => (
            <div key={section.title}>
              <h3 className="font-basement text-foreground text-lg mb-4">{section.title}</h3>
        ...
        {showContact && (
          <div>
            <div className="mb-6">
              <svg width="48" height="48" className="text-primary-500" viewBox="0 0 27.8 26.7" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              <h3 className="font-basement text-foreground text-lg mb-4">Get In Touch</h3>
              <div className="space-y-3">
                <div className="flex items-center text-sm text-muted-foreground font-kabel">
                  <Mail className="w-4 h-4 mr-2 text-primary-500" />
                  <a href="mailto:your@email.com" className="hover:text-primary-500 transition-colors">
                    your@email.com
                  </a>
                </div>
              ...
              <div className="mt-4 p-3 glass-card rounded-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-basement text-success-500">Available for hire</span>
                </div>
          ...
          <div className="mt-12 pt-8 border-t border-border/50">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="space-y-2">
                <div className="text-2xl font-bold font-basement gradient-text">50+</div>
                <div className="text-sm text-muted-foreground font-kabel">Projects Completed</div>
              </div>
              
              <div className="space-y-2">
                <div className="text-2xl font-bold font-basement gradient-text">25+</div>
                <div className="text-sm text-muted-foreground font-kabel">Happy Clients</div>
              </div>
              
              <div className="space-y-2">
                <div className="text-2xl font-bold font-basement gradient-text">5+</div>
                <div className="text-sm text-muted-foreground font-kabel">Years Experience</div>
              </div>
              
              <div className="space-y-2">
                <div className="text-2xl font-bold font-basement gradient-text">100%</div>
                <div className="text-sm text-muted-foreground font-kabel">Client Satisfaction</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
            <span className="text-xs text-muted-foreground font-kabel mr-2">Built with:</span>
            <Badge variant="neutral" className="text-xs">React</Badge>
            <Badge variant="neutral" className="text-xs">TypeScript</Badge>
            <Badge variant="neutral" className="text-xs">Tailwind CSS</Badge>
            <Badge variant="neutral" className="text-xs">Vite</Badge>
            <Badge variant="neutral" className="text-xs">Lucide Icons</Badge>
          </div>
        </div>
      </div>
    </footer>
