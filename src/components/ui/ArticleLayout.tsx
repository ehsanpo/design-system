          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <Card variant="glass" className="p-4">
                <h4 className="font-basement text-foreground mb-4">Table of Contents</h4>
                <nav className="space-y-2">
                  {content.filter(section => section.title).map((section, index) => (
                    <button
                      key={section.id}
          ...
          <article className="space-y-8">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/50">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    >
                      ...
                      <span className="text-sm font-kabel">{likes + (isLiked ? 1 : 0)}</span>
                    </button>
            ...
            <Card variant="default" padding="lg">
              <div className="space-y-6">
                ...
                {/* Author Bio */}
                <div>
                  <h3 className="font-basement text-foreground text-lg mb-4">About the Author</h3>
                  <AuthorCard
                    name={author.name}
                    bio={author.bio}
                    avatar={author.avatar}
                ...
                {/* Share Section */}
                <div>
                  <h3 className="font-basement text-foreground text-lg mb-4">Share this Article</h3>
                  <ShareButtons
                    title={title}
                    description={excerpt}
                    hashtags={tags}
            ...
            {relatedArticles.length > 0 && (
              <Card variant="gradient" padding="lg">
                <CardTitle className="font-basement text-white mb-6">Related Articles</CardTitle>
